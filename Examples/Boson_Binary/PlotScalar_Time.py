...
data = np.genfromtxt("/lustre/astro/spieksma/Sims_Scalar/Sims_Scalar/data_line_ex_phi/data_out.dat")
data_hr2 = np.genfromtxt("/lustre/astro/spieksma/Sims_Scalar/Sims_Scalar/data_line_ex_phi_hr/data_out.dat")
...
ax1.plot(data_lineout[:,0], data_lineout[:,1], label = r'$x = 0M$')
...
ax2.plot(data[:,0], data[:,1], label = r'$||\mathcal{H}||$')
