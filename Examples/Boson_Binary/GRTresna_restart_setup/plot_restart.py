...
# Read data
x_LR = np.loadtxt('/lustre/astro/spieksma/Sims_Scalar/Boson_Cloud_LR/data/constraint_lineout.dat')[:,0]
Ham_LR = np.loadtxt('/lustre/astro/spieksma/Sims_Scalar/Boson_Cloud_LR/data/constraint_lineout.dat')[:,1]
Mom_LR = np.loadtxt('/lustre/astro/spieksma/Sims_Scalar/Boson_Cloud_LR/data/constraint_lineout.dat')[:,2]
